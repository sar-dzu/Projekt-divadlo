            ...
            <div class="col-12">
                <nav class="main-nav">
                    ...
                    <ul class="nav">
                        ...
                        <li><a href="index.php#nextShows"><i class="fa fa-calendar"></i> Nadchádzajúce predstavenia</a></li>

                        <?php if ($admin->isLoggedIn()): ?>
                            <li><a href="zobrazit-hry.php"><i class="fa fa-cog"></i> Správa predstavení</a></li>
